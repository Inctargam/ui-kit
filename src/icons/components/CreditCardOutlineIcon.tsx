...
export function CreditCardOutlineIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      ...
      />
      <path fill="currentColor" d="M7 15h4a1 1 0 0 0 0-2H7a1 1 0 0 0 0 2m8 0h2a1 1 0 0 0 0-2h-2a1 1 0 0 0 0 2" />
    </svg>
  )
}
