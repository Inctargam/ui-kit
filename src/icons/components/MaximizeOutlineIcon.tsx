...
export function MaximizeOutlineIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      ...
      />
      <path fill="currentColor" d="M13 10h-1V9a1 1 0 0 0-2 0v1H9a1 1 0 0 0 0 2h1v1a1 1 0 0 0 2 0v-1h1a1 1 0 0 0 0-2" />
    </svg>
  )
}
