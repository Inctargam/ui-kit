...
export function PaidIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}>
      <path
        fill="var(--color-primary-500, #397df6)"
      ...
      />
      <g fill="var(--color-text-on-accent, #fff)" clipPath="url(#PaidIcon-a)">
        <path d="M15.08 8.14a.667.667 0 0 0-.94.113l-4.667 6-2.286-2.786a.666.666 0 1 0-1.04.833l2.78 3.453a.67.67 0 0 0 .52.247.67.67 0 0 0 .553-.253l5.22-6.667a.667.667 0 0 0-.14-.94m3.333 0a.666.666 0 0 0-.94.113l-4.666 6-.407-.5-.84 1.08.733.914a.67.67 0 0 0 1.04-.007l5.22-6.667a.666.666 0 0 0-.14-.933" />
        <path d="m9.807 12.707.86-1.08-.134-.16a.666.666 0 0 0-1.12.066.67.67 0 0 0 .067.74z" />
      </g>
      <defs>
        <clipPath id="PaidIcon-a">
          <path fill="var(--color-text-on-accent, #fff)" d="M4 4h16v16H4z" />
        </clipPath>
      </defs>
    </svg>
  )
