...
export function PauseCircleOutlineIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
      {...props}>
      <path fill="currentColor" d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20m0 18a8 8 0 1 1 0-16.001A8 8 0 0 1 12 20" />
      <path
        fill="currentColor"
